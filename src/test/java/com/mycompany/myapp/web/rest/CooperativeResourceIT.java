...
public class CooperativeResourceIT {
    ...
    public void createCooperative() throws Exception {
        ...
        assertThat(testCooperative.getSurname()).isEqualTo(DEFAULT_SURNAME);
        assertThat(testCooperative.getTelephone()).isEqualTo(DEFAULT_TELEPHONE);
    ...
    public void updateCooperative() throws Exception {
        ...
        assertThat(testCooperative.getSurname()).isEqualTo(UPDATED_SURNAME);
        assertThat(testCooperative.getTelephone()).isEqualTo(UPDATED_TELEPHONE);
